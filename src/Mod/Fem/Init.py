...
FreeCAD.addImportType("FEM mesh YAML/JSON (*.yaml *.json)", "feminout.importYAMLJSONMesh")
FreeCAD.addExportType("FEM mesh YAML/JSON (*.yaml *.json)", "feminout.importYAMLJSONMesh")
